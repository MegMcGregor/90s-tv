...
namespace NinetiesTV
{
    class Program
    {
        ...
        **************************************************************************************************/
        ...
        {
            List<Show> SortedShows = shows.OrderByDescending(s => s.ImdbRating).ToList();
            return SortedShows;
        }
        ...
        {
            List<Show> AmpersandShows = shows.Where(s => s.Name.Contains("&") == true).ToList();
        ...
        {
            int MostRecentShow = shows.Max(s => s.EndYear);
